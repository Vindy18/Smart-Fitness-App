...
public class DBHelperWeightTrainer extends SQLiteOpenHelper {
    ...
    public int updateWeightTrainer(EditText name, EditText location, EditText contactnumber, EditText email
            , EditText about){
        SQLiteDatabase db= getReadableDatabase();
        ContentValues values = new ContentValues();
        values.put(WeightTrainerMaster.WeightTrainer.COLUMN_NAME_NAME, String.valueOf(name));
        values.put(WeightTrainerMaster.WeightTrainer.COLUMN_NAME_LOCATION, String.valueOf(location));
        values.put(WeightTrainerMaster.WeightTrainer.COLUMN_NAME_CONTACTNUMBER, String.valueOf(contactnumber));
        values.put(WeightTrainerMaster.WeightTrainer.COLUMN_NAME_EMAIL, String.valueOf(email));
